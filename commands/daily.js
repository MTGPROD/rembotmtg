...
exports.run = (client, message, args) => {
  ...
  let money = client.shareholders.getProp(key, "moneyOut")
  let xp = client.shareholders.getProp(key, "xp")
  let gems = client.shareholders.getProp(key, "gems")
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .setTitle(`(**${client.shareholders.getProp(key, "moneyOut")}** + **${client.shareholders.getProp(key, "moneyIn")}** :dollar:) **${xp}** <:xp:611220945285152776> **${gems}** :gem:`)
    .setDescription(`Here's your daily reward, you can also use \`r!hourly\` to earn more.\n\n+**${random_number}** :dollar:, +**${random_number_xp}** <:xp:611220945285152776>, +**${random_number_gems}** :gem:`)
