...
exports.run = (client, message, args, ops) => {
    ...
    if(args[0] === 'presidentext') return message.channel.send({embed: presidentext})
        ...
        .addField('News', 'All commands have been restored, if you find any error please report it to me with the command `r!bugreport`')
        ...
        .setColor('#329FFE')
        .setThumbnail(message.author.avatarURL)
        .addField('Support Rem', 'If you love Rem and you want to support it for free can click on this [link](Je viens de trouver une bonne application, allez voir: http://ss.1yfdy.net/item?u=2027739849&s=310&a=8e2db4ae177be998&is_download=true&dp=1) (with your mobile phone) and download the application, and detele it. You have donated 0.10USD to Rem congratulations🎊.')
        .addField('Basics', `${cmds.Basics}`)
        .addField('Fun', `${cmds.Fun}`)
        .addField('Games', cmds.Games)
        .addField('Music', `${cmds.Music}`)
