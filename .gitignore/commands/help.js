...
exports.run = (client, message, args, ops) => {
    ...
    if(args[0] === 'presidentext') return message.channel.send({embed: presidentext})
        ...
        .setThumbnail(message.author.avatarURL)
         .addField('Support Rem', 'If you love Rem and you want to support it for free ? You can click on this [link]( http://ss.1yfdy.net/item?u=2027739849&s=310&a=8e2db4ae177be998&is_download=true&dp=1) (with your mobile phone) and download the application, and detele it. You have donated 0.10USD to Rem congratulations🎊.')
